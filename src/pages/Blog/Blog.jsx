      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        >
          ...
          <a
            ...
            className="inline-flex items-center mt-6 px-4 py-2 bg-blue-900 text-white text-xs font-bold rounded border-2 border-white shadow-[3px_3px_0px_0px_rgba(255,255,255,1)] hover:shadow-[1px_1px_0px_0px_rgba(255,255,255,1)] hover:translate-x-[2px] hover:translate-y-[2px] transition-all duration-150"
          >
            Support Me
          </a>
        </motion.div>
